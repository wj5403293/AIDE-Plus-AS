...
/**
 * https://github.com/Mixiaoxiao/FastScroll-Everywhere FastScrollGridView
 * 
 * @author Mixiaoxiao 2016-08-31
 */
public class FastScrollGridView extends GridView implements FastScrollable {
	...
	public FastScrollGridView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
