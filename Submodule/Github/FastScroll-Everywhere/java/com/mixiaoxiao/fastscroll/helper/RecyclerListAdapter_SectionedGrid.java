...
public class RecyclerListAdapter_SectionedGrid extends FastScrollRecyclerView.Adapter<FastScrollRecyclerView.ViewHolder> {
    ...
    private final SectionBinder mSectionBinder;
    private final LayoutInflater mLayoutInflater;
    private final FastScrollRecyclerView.Adapter mBaseAdapter;
    ...
    @Override
    public FastScrollRecyclerView.@NotNull ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int typeView) {
    ...
    @Override
    public void onBindViewHolder(FastScrollRecyclerView.@NotNull ViewHolder sectionViewHolder, int position) {
