...
public class RecyclerListAdapter<T> extends FastScrollRecyclerView.Adapter<RecyclerListAdapter.ItemViewHolder>
    ...
    @Override
    public @NotNull ItemViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final @NotNull ItemViewHolder holder, int position) {
        if(mBinder!=null) {
